...
#set DSSchedModeFairshareParams "fairshare ExtendedHighConsumptionStateThreshold=0.95 MonitorPeriod=60 SubscriberProvisionedBW=6.0"
...
set DSSCHEDQType $PBCoDelQ
set DSSchedQParams "pbcodel MaxBins=3 MonitorPeriod=1 PortCapacity=935000000.0"
#
#set DSSCHEDQSize 2048	; # equivalent to 2 queue of 1024
set DSSCHEDQSize 16384	; # equivalent to 2 queue of 8192
#
